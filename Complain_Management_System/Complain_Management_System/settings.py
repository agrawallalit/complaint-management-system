"""
Django settings for Complain_Management_System project.
...
SECRET_KEY = '3_ly7xiokc^$h%uq6uq1_kqpmo7b6_ni4a&enz9(*fp*o1d+1n'
...
WSGI_APPLICATION = 'Complain_Management_System.wsgi.application'
